          ...
          <TabPanel>
            <VStack spacing={4} align="stretch">
              <FormControl>
                ...
                <FormHelperText>
                  Link to the component's repository
                </FormHelperText>
              </FormControl>
              ...
              <FormControl>
                ...
                <FormHelperText>
                  Link to the Google Cloud Console
                </FormHelperText>
              </FormControl>
            </VStack>
          </TabPanel>
            ...
            <VStack spacing={4} align="stretch">
              <Box>
                <HStack mb={4} justify="space-between">
                  ...
                  <Badge
                    colorScheme={
                      selectedNode.data.status === "active" ? "green" : "red"
                    }
                  >
