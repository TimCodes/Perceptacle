...
* **Architecture**
  ...
  * **Components**
    * [Azure Components](AZURE_COMPONENTS.md)
    * [Kubernetes Components](KUBERNETES_COMPONENTS.md)
    * [GitHub Implementation](GITHUB_IMPLEMENTATION_SUMMARY.md)
  * **Infrastructure**
    * [Docker Setup](DOCKER.md)
    * [Dynamic Node Config](DYNAMIC_NODE_CONFIG.md)

* **Code**
  * **Server**
    * [Database Schema](files/server/db/schema.md)
    * [Database Connection](files/server/db/connection.md)
    * [Vite Configuration](files/server/vite.md)
    * **Services**
      * [GitHub Service](files/server/services/github.md)
      * [AI Chat Service](files/server/services/aichat.mock.md)
    * **Utils**
